    ...
    <section id="about" className="bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-10">
          ...
          >
            <span
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase border mb-6"
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold text-text-primary leading-[1.1] tracking-tight">
              Two forces.<br />
              <span style={{ color: "#4f46e5" }}>One mission</span> — to grow your business.
            </h2>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <div
              className="absolute -top-8 -left-4 text-[9rem] font-black leading-none select-none pointer-events-none"
              style={{ color: "#4f46e5", opacity: 0.06 }}
            >
              01
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden aspect-3/2">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div
                  className="inline-flex items-center gap-2.5 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-2xl shadow-xl border border-white/20"
                >
            ...
            <motion.div
              ...
              className="absolute -right-6 top-16 bg-white rounded-2xl px-5 py-4 shadow-2xl border border-[#e2e8f0] z-10"
            >
          ...
          >
            ...
            <div className="flex flex-wrap gap-2.5">
              {recruitmentTags.map((tag) => (
                <span
                  key={tag}
                  className="px-3.5 py-1.5 rounded-full text-xs font-bold border transition-all duration-200 hover:scale-105 cursor-default"
                  style={{ background: "#eef2ff", color: "#4f46e5", borderColor: "#c7d2fe" }}
                >
                  {tag}
                </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="flex flex-wrap gap-2.5">
              {marketingTags.map((tag) => (
                <span
                  key={tag}
                  className="px-3.5 py-1.5 rounded-full text-xs font-bold border transition-all duration-200 hover:scale-105 cursor-default"
                  style={{ background: "#f0fdfe", color: "#0891b2", borderColor: "#a5f3fc" }}
                >
                  {tag}
                </span>
              ))}
          ...
          >
            {/* Large number watermark */}
            <div
              className="absolute -top-8 -right-4 text-[9rem] font-black leading-none select-none pointer-events-none text-right"
              style={{ color: "#06b6d4", opacity: 0.06 }}
            >
              02
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.6, duration: 0.5 }}
              className="absolute -left-6 top-16 bg-white rounded-2xl px-5 py-4 shadow-2xl border border-[#e2e8f0] z-10"
            >
