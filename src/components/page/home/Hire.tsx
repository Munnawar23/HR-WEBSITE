...
export function Hire() {
  return (
    <section id="hire" className="py-20 lg:py-28 bg-slate-50 relative overflow-hidden">
      {/* Decorative background grids */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.02]" style={{ backgroundImage: "radial-gradient(#4f46e5 1.5px, transparent 1.5px)", backgroundSize: "32px 32px" }} />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Header Block */}
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24 flex flex-col items-center gap-5">
          <span
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <motion.div
            ...
            className="group relative bg-white border border-slate-100 hover:border-indigo-100 p-8 sm:p-12 rounded-4xl flex flex-col justify-between transition-all duration-300 hover:shadow-[0_24px_50px_rgba(79,70,229,0.06)] overflow-hidden"
          >
            {/* Interactive Corner Accent */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-50/50 rounded-bl-[4rem] group-hover:bg-indigo-100/60 transition-colors duration-300" />
            
            <div>
              {/* Icon */}
              <div className="w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 mb-8 group-hover:scale-110 transition-transform duration-300">
          ...
          <motion.div
            ...
            className="group relative bg-white border border-slate-100 hover:border-cyan-100 p-8 sm:p-12 rounded-4xl flex flex-col justify-between transition-all duration-300 hover:shadow-[0_24px_50px_rgba(6,182,212,0.06)] overflow-hidden"
          >
            {/* Interactive Corner Accent */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-50/50 rounded-bl-[4rem] group-hover:bg-cyan-100/60 transition-colors duration-300" />
            
            <div>
              {/* Icon */}
              <div className="w-14 h-14 rounded-2xl bg-cyan-50 flex items-center justify-center text-cyan-600 mb-8 group-hover:scale-110 transition-transform duration-300">
